...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 bg-opacity-75 backdrop-blur-sm z-[1000] flex justify-center items-center"
      onClick={handleBackdropClick}
    >
      <div
        className={`flex flex-col border border-[#272727] rounded-lg  md:w-[400px] ${
          bg ? bg : "bg-[#0C0C0C]"
        } ${width ? "w-full" : "w-[95%]"}`}
